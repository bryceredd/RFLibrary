...
Pod::Spec.new do |s|
  ...
  #
  s.source   = { :git => 'git@github.com:bryceredd/RFLibrary.git', :tag => '1.0.0' }
  # s.source   = { :svn => 'http://EXAMPLE/RFLibrary/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/RFLibrary', :revision => '1.0.0' }
  ...
  #
  s.source_files = 'RFLibrary', 'RFLibrary/**/*.{h,m}'
